...
export default function NoteDescription(props: {title: string, text: string, hidden: boolean, onclick: MouseEventHandler<Element> | undefined}) {
    return (
        <div onClick={props.onclick} hidden={props.hidden} className="note-description text-gray-900 whitespace-pre-wrap fixed lg:absolute w-56 lg:w-64 pl-3 pr-6 py-3 rounded-lg top-20 right-4 sm:rounded-lg bg-yellow-50 text-left drop-shadow-xl m-auto">
