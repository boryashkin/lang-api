const policy = `
Настоящий документ «Политика конфиденциальности» (далее по тексту – «Политика») представляет собой правила использования "Десятским Б.Д. ИНН 861006973167 langapi@borisd.ru" (далее – «мы» и/или «Администрация») данных интернет-пользователей (далее «вы» и/или «Пользователь»), собираемых с использованием сайта langapi.borisd.ru (далее – «Сайт»).
...
Действующая редакция Политики от 28.06.2023 г.
`
...
export default async function Page() {
    ...
    return (
        <div className="mx-auto container">
            <div className="relative overflow-hidden sm:rounded-lg bg-white text-left shadow-xl transition-all m-auto p-4">
            <h1>Политика конфиденциальности</h1>
            <pre className="whitespace-pre-wrap">
                {policy}
            </pre>
            Политику разработала <a href="http://it-lex.ru" target="_blank" title="Составить политику конфиденциальности для сайта">Юридическая компания АйТи-Лекс</a>
            </div>
        </div>
    );
}
